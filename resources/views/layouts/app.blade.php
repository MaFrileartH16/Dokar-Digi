...
<head>
  ...
  <title>@yield('title', 'Welcome') - Dokar Digi</title>
  <!-- BEGIN PAGE LEVEL STYLES -->
  <link href="{{ asset('libs/jsvectormap/dist/jsvectormap.css') }}" rel="stylesheet"/>
...
<script src="{{ asset('dist/js/tabler.min.js') }}?v={{ filemtime(public_path('dist/js/tabler.min.js')) }}"
        defer></script>
